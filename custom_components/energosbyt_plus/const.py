...
DEFAULT_NAME_FORMAT_EN_WORKS: Final = "{account_code_short} {type_en_cap}"
...
DEFAULT_NAME_FORMAT_RU_WORKS: Final = "{account_code_short} {type_ru_cap}"
